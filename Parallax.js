...
// }
// let scrollAnimationFrameId = null; // Tracking variable for scroll animation

// export function scrollToPlanet(index) {
//     const spaceView = document.getElementById('space-view');
//     const planetDiv = document.getElementById(`body-${index}`);
//     const endLeft = planetDiv.offsetLeft + planetDiv.offsetWidth / 2 - spaceView.offsetWidth / 2;
//     const startLeft = spaceView.scrollLeft;
...
//         } else {
//             // Optional: Callback or event signaling that the animation is complete
//         }
//     }
