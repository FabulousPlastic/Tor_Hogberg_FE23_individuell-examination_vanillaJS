...
//         window.addEventListener('resize', initializeCelestialBodies);  // Add event listener for window resize
...
//     setupParallaxLayers(spaceView);

//     bodies.forEach((body, index) => createCelestialBody(body, index));
//     setupPlanetPositions();  // Update planet positions after re-rendering
// }

// function setupParallaxLayers(container) {
//     const layers = [
//         { depth: 0.2, className: 'parallax-layer' },
//         { depth: 0.5, className: 'parallax-layer' },
//         { depth: 1.0, className: 'parallax-layer' }
//     ];

//     layers.forEach(layer => {
//         const layerDiv = document.createElement('div');
//         layerDiv.className = layer.className;
//         layerDiv.style.setProperty('--depth', layer.depth);
...
// // function initializeCelestialBodies() {
// //     const spaceView = document.getElementById('space-view');
// //     spaceView.innerHTML = ''; // Clear existing celestial bodies
// //     bodies.forEach((body, index) => createCelestialBody(body, index));
// //     setupPlanetPositions();  // Update planet positions after re-rendering
// // }
